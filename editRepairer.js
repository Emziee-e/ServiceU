      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileSection}>
          <View style={styles.profileImageContainer}>
            <Image 
              source={require('./assets/repairer3.jpg')} 
          ...
          <Text style={styles.repairerName}>
            {repairerData.name} <Image source={getGenderIcon()} style={styles.genderIcon} />
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <InfoField label="Email" value={repairerData.email} />
          <InfoField label="Phone Number" value={repairerData.phone} />
        </View>
        ...
        <View style={styles.section}>
          ...
          <InfoField 
            label="Expertise" 
            value={repairerData.expertise} 
            editable 
            onPress={handleEditExpertise}
          />
          <InfoField 
            label="Gender" 
            value={repairerData.gender} 
            editable 
